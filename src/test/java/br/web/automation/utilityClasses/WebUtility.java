...
public class WebUtility {
    ...
    private static void setupDriverPaths() {
        ...
        if (operatingSystem.equals("WINDOWS")) {
            System.setProperty("webdriver.chrome.driver","drivers/chromeDriverWindows.exe");
            System.setProperty("webdriver.gecko.driver", "drivers/firefoxDriverWindows.exe");
        }

        if (operatingSystem.equals("MACOS")) {
            System.setProperty("webdriver.chrome.driver","drivers/chromeDriverMac");
            System.setProperty("webdriver.gecko.driver", "drivers/firefoxDriverMac");
        }
